...
<form on:submit|preventDefault={() => {dispatch("created", {...form})}} class="p-4 flex flex-col gap-2">
    ...
    <div class="flex gap-3">
        <Dropzone id="dropzone" multiple bind:files={form.files} class="flex-1">
            <svg
                    aria-hidden="true"
